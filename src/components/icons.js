...
export const IconEye = i('Eye', (
  <svg width="16" height="16" viewBox="0 0 16 16">
    <g className="line" fill="currentColor">
      <path d="M8,3C11.519,3 14.552,5.042 16,8C14.552,10.958 11.519,13 8,13C4.481,13 1.448,10.958 0,8C1.448,5.042 4.481,3 8,3ZM8,4C5.127,4 2.538,5.52 1.13,8C2.538,10.48 5.127,12 8,12C10.873,12 13.462,10.48 14.87,8C13.462,5.52 10.873,4 8,4ZM11,8C11,9.657 9.657,11 8,11C6.343,11 5,9.657 5,8C5,6.343 6.343,5 8,5C9.657,5 11,6.343 11,8ZM9.25,8C9.25,7.31 8.69,6.75 8,6.75C7.31,6.75 6.75,7.31 6.75,8C6.75,8.69 7.31,9.25 8,9.25C8.69,9.25 9.25,8.69 9.25,8Z"/>
    </g>
  </svg>
))

export const IconEyeClosed = i('EyeClosed', (
  <svg width="16" height="16" viewBox="0 0 16 16">
    <g className="line" fill="currentColor">
      <path d="M2.385,10.984C1.624,10.357 0.967,9.606 0.446,8.763C0.301,8.528 0.373,8.22 0.608,8.075C0.843,7.93 1.151,8.002 1.296,8.237C2.688,10.487 5.16,12 8,12C10.84,12 13.312,10.487 14.704,8.237C14.849,8.002 15.157,7.93 15.392,8.075C15.627,8.22 15.699,8.528 15.554,8.763C15.22,9.303 14.83,9.806 14.393,10.262L15.779,11.758C15.967,11.96 15.955,12.277 15.752,12.464C15.55,12.652 15.233,12.64 15.046,12.438L13.663,10.945C13.138,11.383 12.563,11.761 11.947,12.07L12.743,13.934C12.852,14.188 12.734,14.482 12.48,14.59C12.226,14.698 11.932,14.58 11.824,14.327L11.029,12.466C10.393,12.699 9.722,12.86 9.027,12.941L9.148,14.97C9.164,15.246 8.954,15.483 8.679,15.499C8.403,15.516 8.166,15.305 8.15,15.03L8.029,13C8.019,13 8.01,13 8,13C7.308,13 6.635,12.92 5.99,12.77L5.423,14.71C5.346,14.975 5.068,15.127 4.803,15.05C4.538,14.972 4.386,14.694 4.464,14.429L5.031,12.488C4.379,12.255 3.762,11.947 3.191,11.576L1.999,13.219C1.837,13.442 1.524,13.492 1.3,13.33C1.077,13.168 1.027,12.855 1.189,12.632L2.385,10.984Z"/>
    </g>
  </svg>
))
...
export const IconMinimize = i('Minimize', (
  <svg width="16" height="16" viewBox="0 0 16 16" overflow="visible">
    <g className="line" fill="currentColor">
      <path fillRule="evenodd" d="M-8,-8h32v32h-32ZM14.854,1.854l-4.146,4.146h3.293v1h-4.5c-.065,0-.13-.013-.191-.038-.122-.051-.22-.148-.271-.271-.025-.061-.038-.126-.038-.191V2h1v3.293L14.146,1.146c.195-.195.512-.195.707,0s.195.512,0,.707ZM6.691,9.038c-.061-.025-.126-.038-.191-.038H2v1h3.293L1.146,14.146c-.195.195-.195.512,0,.707.098.098.226.146.354.146s.256-.049.354-.146l4.146-4.146v3.293h1v-4.5c0-.065-.013-.13-.038-.191-.051-.122-.148-.22-.271-.271Z"/>
    </g>
  </svg>
))
...
export const IconDotsVertical = i('DotsVertical', (
  <svg width="16" height="16" viewBox="0 0 16 16">
