...
i('ContrastMin', (
  <svg width="16" height="16" >
    <g className="line" fill="currentColor">
      <path d="M8,2A6,6,0,1,1,2,8,6.007,6.007,0,0,1,8,2M8,1a7,7,0,1,0,7,7A7,7,0,0,0,8,1Z"/>
    </g>
  </svg>
))
...
i('SunSmall', (
  <svg width="16" height="16">
    <g className="line" fill="currentColor">
      <path d="M11.84,6.95l1.894-.785-.383-.924-1.883.78A3.966,3.966,0,0,0,9.977,4.534l.781-1.886-.924-.383-.78,1.882A3.992,3.992,0,0,0,8,4a3.99,3.99,0,0,0-1.048.16L6.166,2.265l-.924.383.785,1.894A3.955,3.955,0,0,0,4.54,6.026L2.648,5.242l-.383.924,1.892.784a3.956,3.956,0,0,0,0,2.1l-1.894.785.383.924,1.883-.78a3.966,3.966,0,0,0,1.492,1.488l-.781,1.886.924.383.78-1.882A3.992,3.992,0,0,0,8,12a3.99,3.99,0,0,0,1.048-.16l.784,1.893.924-.383-.785-1.894A3.955,3.955,0,0,0,11.46,9.974l1.892.784.383-.924-1.892-.784A3.955,3.955,0,0,0,11.84,6.95ZM9.149,10.771h0a3,3,0,0,1-2.3-5.544h0a3,3,0,0,1,3.919,1.623h0A3,3,0,0,1,9.149,10.771Z"/>
    </g>
  </svg>
))
