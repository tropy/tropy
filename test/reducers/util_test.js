  ...
  describe('nested', () => {
    ...
    describe('add', () => {
      ...
      it('supports single id calls', () => {
        ...
        expect(s1).to.have.deep.property('1.tags').eql([1])
        expect(s2).to.have.deep.property('1.tags').eql([1, 2])
        expect(s3).to.have.deep.property('1.tags').eql([1, 2, 3, 4])
      })
      ...
      it('supports multiple id calls', () => {
        ...
        expect(s2).to.have.deep.property('1.tags').eql([1, 2])
        expect(s3).to.have.deep.property('1.tags').eql([1, 2, 3, 4])
        expect(s1).to.have.deep.property('2.tags').eql([1])
        expect(s2).to.have.deep.property('2.tags').eql([1, 2])
        expect(s3).to.have.deep.property('2.tags').eql([1, 2, 3, 4])
      })
      ...
      it('supports meta.idx', () => {
        ...
        expect(s1).to.have.deep.property('1.tags').eql([1, 2, 3])
        expect(s2).to.have.deep.property('1.tags').eql([1, 4, 5, 2, 3])
      })
    })
    ...
    describe('remove', () => {
      ...
      it('supports single id calls', () => {
        ...
        expect(s1).to.have.deep.property('2.tags').eql([1, 3])
        expect(s2).to.have.deep.property('2.tags').eql([])
      })

      it('supports multiple id calls', () => {
        let s1 = nested.remove('tags', state, { id: [1, 2], tags: [1, 2] })

        expect(s1).to.have.deep.property('1.tags').eql([])
        expect(s1).to.have.deep.property('2.tags').eql([3])
      })
    })
  })
})
